...
void main() {
  group('Rest & Focus Module Tests', () {
    testWidgets('RestView: segmented mode switching and muyu strike interaction', (WidgetTester tester) async {
    ...
    testWidgets('AppShell integration: navigate to RestView via SideNavRail and Floating Pomodoro',
