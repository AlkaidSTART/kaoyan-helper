...
void main() {
  group('Core Business Modules Tests', () {
    testWidgets(
      'QuizView: select wrong option, check feedback, unfold explanation, and advance',
    ...
    testWidgets('MistakesView: filter by subject and redo elimination', (
      WidgetTester tester,
    ) async {
      tester.view.physicalSize = const Size(1280, 800);
      tester.view.devicePixelRatio = 1.0;
    ...
    testWidgets(
      'SchoolsView: search filtering, trend expansion, and star toggle',
      (WidgetTester tester) async {
        tester.view.physicalSize = const Size(1280, 800);
        tester.view.devicePixelRatio = 1.0;
        addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('FlashcardsView: 3D flip card and rating progression', (
      WidgetTester tester,
    ) async {
      tester.view.physicalSize = const Size(1280, 800);
      tester.view.devicePixelRatio = 1.0;
