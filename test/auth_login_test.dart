...
void main() {
  group('Auth Login & Interceptor Tests', () {
    testWidgets('Default interception: unauthenticated user lands on LoginPage', (WidgetTester tester) async {
    ...
    testWidgets('Quick filler button populates credentials and checks agreement', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1280, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      addTearDown(tester.view.resetDevicePixelRatio);
    ...
    testWidgets('Mock login and logout interception full closed loop', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1280, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      addTearDown(tester.view.resetDevicePixelRatio);
      ...
      expect(container.read(authNotifierProvider).currentUser?.nickname, '登科研友');
